...
class MinimalSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.subscription_detect = self.create_subscription(Detection,'/yolo_detected', self.listener_callback,10)
        
    # 로직 2. callback 함수 생성
    ## 메시지가 수신될 때 마다 호출되는 함수로 메시지의 내용을 출력하고 있습니다.
    def listener_callback(self,msg):
        print("Detection Info: x={}, y={}, confidence={}, name={}".format(msg.x, msg.y, msg.confidence, msg.name))

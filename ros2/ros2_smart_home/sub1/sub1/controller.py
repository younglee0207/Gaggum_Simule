...
class Controller(Node):
    ...
    def timer_callback(self):
        ...
        menu = int(input("터틀봇 제어 : "))
        if menu == 0:
            self.turtlebot_go()
        elif menu == 1:
            print(f'Turtlebot : {self.turtlebot_status_msg}')
            print(f'Environment : {self.envir_status_msg}')
            print(f'APP : {self.app_status_msg}')
        elif menu == 2:
